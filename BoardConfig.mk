...
ifneq ($(WITH_GMS),true)
BOARD_PRODUCTIMAGE_PARTITION_RESERVED_SIZE := 3213369344
BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE := 768823296
BOARD_SYSTEM_EXTIMAGE_PARTITION_RESERVED_SIZE := 811442176
endif
